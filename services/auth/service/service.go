...
func (s *AuthService) GetCurrentSession(ctx context.Context, req *authrepo.ReqSession) (*types.Session, error) {
	return s.AuthRepository.GetCurrentSession(ctx, req)
}

func (s *AuthService) UpdateSessionActvity(ctx context.Context, req string) (*types.Session, error) {
	return s.AuthRepository.UpdateSessionActivity(ctx, req)
}
